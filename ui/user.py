...
def user_dashboard(current_email): # Accepts the logged in email
    ...
    class Ui_MainWindow(object):
        def setupUi(self, MainWindow):
            ...
            self.user_email = current_email # Store email
            ...
            sidebar_btn_style = u"""
            QPushButton {
                background-color: transparent; color: #34495e; text-align: left; padding-left: 20px; font-size: 16px; border: none; height: 50px;
            }
            ...
            self.inputBookName = QLineEdit(placeholderText="Enter Book Name to Borrow/Return")
            ...
            self.dateInput.setDate(QDate.currentDate().addDays(7)) # Default 7 days
            ...
            self.tableBrowse.setColumnCount(2)
            self.tableBrowse.setHorizontalHeaderLabels(["Book Name", "Status"])
